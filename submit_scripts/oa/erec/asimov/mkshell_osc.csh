...
echo $exedir/SensiAsimov_nu_nubar \
	-f $iodir/$ana/merger/m10k_202211_t0k_nuR16_nubarR56 \
	-o $iodir/$ana/asimov/g10k_set3_202211_s0_m10k_t0k_nuR16_nubarR56_p5/asimov$i.root  \
...
#numubar inverted
echo $exedir/SensiAsimov_nu_nubar \
	-f $iodir/$ana/merger/m10k_202211_t0k_nuR16_nubarR56_h \
	-o $iodir/$ana/asimov/g10k_set3_202211_s0_m10k_t0k_nuR16_nubarR56_p5_h/asimov$i.root  \
	-e $iodir/$ana/generate/g10k_set3_m15_nuR16_nubarR56_s0.root -a $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root \
	-m 3 -n 10000 -b $i >> $shell_name
#numu normal
echo $exedir/SensiAsimov_nu_nubar \
	-f $iodir/$ana/merger/m10k_201122_t0k_nuR16_nubarR56 \
	-o $iodir/$ana/asimov/g10k_set3_201122_s0_m10k_t0k_nuR16_nubarR56_p5/asimov$i.root  \
	-e $iodir/$ana/generate/g10k_set3_m15_nuR16_nubarR56_s0.root -a $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root \
	-m 3 -n 10000 -b $i >> $shell_name
#numu inverted
echo $exedir/SensiAsimov_nu_nubar \
	-f $iodir/$ana/merger/m10k_201122_t0k_nuR16_nubarR56_h \
	-o $iodir/$ana/asimov/g10k_set3_201122_s0_m10k_t0k_nuR16_nubarR56_p5_h/asimov$i.root  \
	-e $iodir/$ana/generate/g10k_set3_m15_nuR16_nubarR56_s0.root -a $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root \
	-m 3 -n 10000 -b $i >> $shell_name
  set i = `expr $i + 1`
end
