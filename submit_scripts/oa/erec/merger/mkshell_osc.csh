...
while ( $i < $n + $nbins )
	#numu r16 stats only
	#echo $exedir/Merger -t $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root -o $iodir/$ana/merger/m10k_201122_t0k_nuR16_nubarR56/ \
	#	-i $i -ft $iodir/inputs/Throws/Osc_2016_pdg2015_reac2015.root -n 10000 >> $shell_name
	#echo $exedir/Merger -t $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root -o $iodir/$ana/merger/m10k_201122_t0k_nuR16_nubarR56_h/ \
	#	-i $i -ft $iodir/inputs/Throws/Osc_2016_pdg2015_reac2015.root -n 10000 -h >> $shell_name
	#numubar r16 stats only
	echo $exedir/Merger -t $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root -o $iodir/$ana/merger/m10k_202211_t0k_nuR16_nubarR56/ \
		-i $i -ft $iodir/inputs/Throws/Osc_2016_pdg2015_reac2015.root -n 10000 >> $shell_name
	echo $exedir/Merger -t $iodir/$ana/template/tpl_t0k_nuR16_nubarR56.root -o $iodir/$ana/merger/m10k_202211_t0k_nuR16_nubarR56_h/ \
		-i $i -ft $iodir/inputs/Throws/Osc_2016_pdg2015_reac2015.root -n 10000 -h >> $shell_name
	set i = `expr $i + 1`
end
